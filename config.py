...
class ParseGRU():
    def __init__(self):
        ...
        parser.add_argument('--trainset', default="/home/jatinsahu/jatin/tempdata/images", help='log directory')
        parser.add_argument('--valset', default="/home/jatinsahu/jatin/tempdata/image", help='log directory')
        parser.add_argument('--testset', default="/home/jatinsahu/jatin/tempdata/images", help='log directory')
        parser.add_argument('--img_extension', default='jpg', help='log directory')
        parser.add_argument('--num_itrs', type=int, default=10000)
        parser.add_argument('--T', type=int, default=1, help='checkpoint epoch')
        ...
        parser.add_argument('--log_folder', default="/home/jatinsahu/jatin/tempdata", help='log directory')
        ...
        parser.add_argument('--check_point', type=int, default=5, help='apply SpectralNorm')#SNシますか?
        parser.add_argument('--n_test', type=int, default=4, help='apply Self-atten')  # Attnシますか?
        parser.add_argument('--n_channels', type=int, default=3, help='apply Self-atten')  # Attnシますか?
        parser.add_argument('--num_epochs', type=int, default=120, help='apply Self-atten')
